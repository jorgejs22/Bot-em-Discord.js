...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (!interaction.member.permissions.has(Discord.PermissionFlagsBits.ManageMessages)) {
            ...
            interaction.reply({ content: `<a:nao:868232161289986128>**|**Você não possui permissão de \`Gerenciar_Mensagens\` para utilizar este comando.`, ephemeral: true })
 ...
 .setAuthor({ name: interaction.guild.name, iconURL: interaction.guild.iconURL({ dynamic: true }) })
                  ...
                  .setDescription(`O Chat ${interaction.channel} teve \`${numero}\` mensagens deletadas por \`${interaction.user.username}\`.`);
